-- Company Updates + # project references + Updates separation (additive)

-- Extend activity / relevance enums
do $$ begin
...
-- Improve project reply relevance: root author → reply_to_your_update
